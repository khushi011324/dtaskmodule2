...
void* consume(void* args){
    ...
    cout << setw(3) << tlSorter[0].tr_id << setw(20) << tlSorter[0].num_cars << endl;
    cout << setw(3) << tlSorter[1].tr_id << setw(20) << tlSorter[1].num_cars << endl;
    cout << setw(3) << tlSorter[2].tr_id << setw(20) << tlSorter[2].num_cars << endl;
    cout << setw(3) << tlSorter[3].tr_id << setw(20) << tlSorter[3].num_cars << endl;
}
...
void get_traff_data(){ 
  ...
  cout << "Hello! Khushi" << endl;
    cout << "Welcome SIT 315 " << endl;
  cout << "Enter your.00000000000000 filename: ";
	cin >> file;
